...
function menuToggle(bool,send=false) {
	...
	if(send){
		$.post('http://mf_tuner/togglemenu', JSON.stringify({state:false}));
	}
}
...
$(function(){
	...
	$("#boost").slider({min:0.05,value:0.25,step:0.01,max:3,change:sliderUpdated});
	...
	$("#savebtn").click(function(){
		initiateTyepwriter();
		$.post('http://mf_tuner/save', JSON.stringify(getSliderValues()));
	});
